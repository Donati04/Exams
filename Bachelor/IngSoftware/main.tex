...
\begin{titlepage}
    ...
    % Titolo principale
	{{\Huge \textbf{Ingegneria del Software}}}\\[\baselineskip]
...
%------------------------------------------------
\raggedright
\input{Sections/write_a_program}
\input{Sections/build_a_program}
\input{Sections/ingegneria_del_software}
\input{Sections/ingegneria_dei_requisiti}
\input{Sections/design_solid}
\input{Sections/archiettura_del_software}
\input{Sections/architettura_pulita}
\input{Sections/metriche_di_qualita}
\input{Sections/modelli_uml}
\input{Sections/implementazione}
\input{Sections/testing}
\input{Sections/design_pattern}
