...
\begin{titlepage}
    ...
    % Titolo principale
	{{\Huge \textbf{Intelligenza Artificiale}}}\\[\baselineskip]
...
\input{Sections/sup_learning.tex}
\input{Sections/bayes_linear.tex}
\input{Sections/svm.tex}
\input{Sections/ensembles.tex}
\input{Sections/random_forest.tex}
\input{Sections/clustering.tex}
\input{Sections/dim_reduction.tex}
\input{Sections/linear_reg.tex}
